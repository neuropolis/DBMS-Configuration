...
TEMP_FILES = "/root/CDBTune/AutoTuner/train_result/tmp"
PROJECT_DIR = "/root/CDBTune/"
...
class MySQLEnv(object):
    ...
    def _get_state(self, knob, method='sysbench'):
        ...
        if method == 'sysbench':
            a = time.time()
            print('test start!')
            os.system("bash %sAutoTuner/scripts/run_sysbench.test.sh %s %s %d %d %s" % (PROJECT_DIR,
                                                                                   self.wk_type,
                                                                                   self.db_info['host'],
                                                                                   self.db_info['port'],
                                                                                   #self.db_info['passwd'],
