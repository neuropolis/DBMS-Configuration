...
def init_knobs(instance, num_more_knobs):
    ...
    EXTENDED_KNOBS = {
        ...
        ##'read_rnd_buffer_size': ['integer', [1, min(memory_size, 134217728), 262144]],  # max: 2147483647
        ...
        ##'query_cache_size': ['integer', [0, min(memory_size, int(memory_size*0.5)), 1048576]],
        ...
        ##'sort_buffer_size': ['integer', [32768, min(memory_size, 134217728), 262144]],
